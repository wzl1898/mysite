...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('comment', '0003_auto_20210218_1539'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='comment',
            name='parent',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='son_comment', to='comment.Comment'),
        ),
        migrations.AlterField(
            model_name='comment',
            name='reply_to',
